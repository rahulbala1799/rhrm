...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Review Submissions', href: '/settings/compliance-documents/review', icon: ClipboardDocumentListIcon },
    ],
  },
  {
    id: 'settings',
    ...
    items: [
      ...
      { label: 'Roles & Permissions', href: '/settings/permissions', icon: LockClosedIcon },
...
export default function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  useEffect(() => {
    ...
    // Only run when pathname changes, not when collapsed changes
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-3 scrollbar-thin">
          {/* Dashboard — pinned top-level link */}
